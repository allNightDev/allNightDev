                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("010-1234-56**님 ", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 20.0)),
                          Row(
                            children: [
                              Text(
                                "내 정보 관리",
...
class _WithIcon extends StatelessWidget {
  const _WithIcon({Key? key, required this.icon, this.child, required this.label}) : super(key: key);
